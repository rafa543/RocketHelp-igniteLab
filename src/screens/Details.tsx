  ...
  return (
    <VStack flex={1} bg="gray.700">
      ...
      <HStack bg="gray.500" justifyContent="center" p={4}>
        ...
        <Text
          fontSize="sm"
          color={order.status === 'closed' ? colors.green[300] : colors.secondary[700]} ml={2}
      ...
      <ScrollView mx={5} showsVerticalScrollIndicator={false}>
        ...
        <CardDetails
          ...
          {order.status === 'open' &&
            <Input placeholder='Descricao da solução' onChangeText={setSolution}
              h={24} textAlignVertical="top" multiline />}
        </CardDetails>
      </ScrollView>
